...
```mermaid
flowchart TD
    A["Real life<br/>your day"] -->|go to bed| B["The camp<br/>a full day, meeting people"]
    B -->|sleep, inside the camp| C["The trip<br/>somewhere on Earth"]
    C -->|wake| B
    B -->|wake| D["Real life<br/>your morning"]
```
